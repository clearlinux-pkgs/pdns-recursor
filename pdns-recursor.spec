...
Source0  : https://downloads.powerdns.com/releases/pdns-recursor-4.5.4.tar.bz2
Source1  : https://downloads.powerdns.com/releases/pdns-recursor-4.5.4.tar.bz2.asc
...
%prep
%setup -q -n pdns-recursor-4.5.4
cd %{_builddir}/pdns-recursor-4.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626108242
...
cp %{_builddir}/pdns-recursor-4.5.4/COPYING %{buildroot}/usr/share/package-licenses/pdns-recursor/1d8c93712cbc9117a9e55a7ff86cebd066c8bfd8
cp %{_builddir}/pdns-recursor-4.5.4/NOTICE %{buildroot}/usr/share/package-licenses/pdns-recursor/b0546213f9970e01098f0ec919c828d83790eb9a
cp %{_builddir}/pdns-recursor-4.5.4/ext/json11/LICENSE.txt %{buildroot}/usr/share/package-licenses/pdns-recursor/d40d61b8fa8ecae46da12bd1fce4162af02cff8c
cp %{_builddir}/pdns-recursor-4.5.4/ext/yahttp/LICENSE %{buildroot}/usr/share/package-licenses/pdns-recursor/cd4a6679c43eb8c0331ebc91648b27b6fd747252
cp %{_builddir}/pdns-recursor-4.5.4/html/LICENSE %{buildroot}/usr/share/package-licenses/pdns-recursor/23a1f87d806ce0330b3d85485e399a5f9f553409
%make_install
