...
Source0  : https://downloads.powerdns.com/releases/pdns-recursor-5.1.2.tar.bz2
Source1  : http://localhost/cgit/vendor/pdns-recursor/snapshot/pdns-recursor-2024-10-03-14-24-15.tar.xz
Source2  : https://downloads.powerdns.com/releases/pdns-recursor-5.1.2.tar.bz2.asc
...
%setup -q -n pdns-recursor-5.1.2
cd %{_builddir}
tar xf %{_sourcedir}/pdns-recursor-2024-10-03-14-24-15.tar.xz
cd %{_builddir}/pdns-recursor-5.1.2
mkdir -p ./vendor
cp -r %{_builddir}/pdns-recursor-2024-10-03-14-24-15/* %{_builddir}/pdns-recursor-5.1.2/./vendor
mkdir -p .cargo
...
' >> .cargo/config.toml
pushd ..
cp -a pdns-recursor-5.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727966322
